package Crystal.buttons 
{
	...
	public class ButtonSound extends Sprite 
	{
		private var _buttonOn:Bitmap;
		private var _buttonOff:Bitmap;
		
		public function ButtonSound(posX:int, posY:int) 
		{
			_buttonOn = new Bitmap(Atlas.AtlasGetBitmap(Resource.ButtonSoundImage, 70, 35, 35, 35, true, 0x000000000000, 0, 0, 35, 35, 0, 0).bitmapData);
			_buttonOn.x = posX; _buttonOn.y = posY;
			this.addChild(_buttonOn);
			
			_buttonOff = new Bitmap(Atlas.AtlasGetBitmap(Resource.ButtonSoundImage, 70, 35, 35, 35, true, 0x000000000000, 35, 0, 35, 35, 0, 0).bitmapData);
