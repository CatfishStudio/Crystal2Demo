package Crystal.buttons 
{
	...
	public class ButtonBlue extends Sprite 
	{
		
		public function ButtonBlue(posX:int, posY:int, posTextX:int , text:String) 
		{
			var button:Bitmap = new Bitmap(Resource.ButtonImage1.bitmapData);
