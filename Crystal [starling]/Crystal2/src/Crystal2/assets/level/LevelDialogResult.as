package Crystal2.assets.level 
{
	...
	public class LevelDialogResult extends Sprite 
	{
		...
		private function onAddedToStage(e:Event):void 
		{
			...
			// метка номер уровня
			if (_status == "WIN") _labelStatus = new TextField(250, 100, "Вы выиграли! " + Resource.SelectLevel, "Arial", 32, 0x8000FF, true);
			if (_status == "LOSE")_labelStatus = new TextField(250, 100, "Уровень проигран!" + Resource.SelectLevel, "Arial", 32, 0x8000FF, true);
			...
			if (_status == "LOSE") _labelResult = new TextField(250, 100, "Вы не выполнили задание.", "Aria", 22, 0x8000FF, true);
